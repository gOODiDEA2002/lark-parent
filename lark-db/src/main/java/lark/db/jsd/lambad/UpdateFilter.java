...
public interface UpdateFilter<T> {
    ...
    CompareFilter<T> set(FieldFunction<T, ?> column, Object value);

    CompareFilter<T> set(Boolean ignoreNullValue, FieldFunction<T, ?> column, UpdateType updateType, Object value);
    UpdateValues set();
