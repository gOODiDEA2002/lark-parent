 ...
 * port: https://github.com/yifanzheng/springboot-action/tree/master/springboot-elasticsearch
 * @author star
 */
public class IndexService {
    ...
    public IndexService( RestHighLevelClient elasticsearchClient ) {
     ...
     * @throws IOException Rest Client 请求异常
     */
    public void save(String index, IndexDocument<?> document) throws IOException {
        IndexRequest indexRequest = new IndexRequest(index);
        indexRequest.id(document.getId());
        indexRequest.source(JsonCodec.encode(document.getData()), XContentType.JSON);
        // 保存文档数据
     ...
     * @throws IOException Rest Client 请求异常
     */
    public <T> void saveAll(String index, List<IndexDocument<T>> documentList) throws IOException {
        ...
        documentList.forEach(doc -> {
            bulkRequest.add(new IndexRequest(index)
                    .id(doc.getId())
                    .source(JsonCodec.encode(doc.getData()), XContentType.JSON));
        });
    ...
    public <T> T get(String index, String id, Class<T> resultType) throws IOException {
        ...
        return JsonCodec.decode(resultAsString, resultType);
    }
    ...
    public <T> List<T> searchByQuery(String index, SearchSourceBuilder sourceBuilder, Class<T> resultType) throws IOException {
        ...
        for (SearchHit hit : hits) {
            ...
            results.add(JsonCodec.decode(sourceAsString, resultType));
        }
